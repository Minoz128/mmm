            ...
            <div class="formControls col-xs-8 col-sm-9">
                <span class="select-box">
                    <select name="status" class="select">
                        ...
                        <option value="0" <?php if($data['status'] == 0): ?> selected="selected"<?php endif; ?> >冻结(该组下所有用户不可登录系统)</option>
                    </select>
				</span>
            </div>
        </div>
