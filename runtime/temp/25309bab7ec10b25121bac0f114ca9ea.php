<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:100:"C:\xampp\htdocs\mmm\public/../application/index\view\dataconfiguration\rendom_select_by_machine.html";i:1548465767;s:61:"C:\xampp\htdocs\mmm\application\index\view\public\header.html";i:1548205508;s:61:"C:\xampp\htdocs\mmm\application\index\view\public\footer.html";i:1548205508;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<article class="page-container">
    <form class="form form-horizontal" id="form-mmm-add">
        ...
        <div class="row cl">
            <label class="form-label col-xs-2 col-sm-2"><span class="c-red">*</span>选择参数组：</label>
            <div class="formControls col-xs-9 col-sm-9"> <span class="select-box">
				<select name="type" class="select">
                    <option value="">-请选择-</option>
                    <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
					    <option value="<?php echo $vo['id']; ?>">-<?php echo $vo['brief']; ?>-</option>
...
<script>
    var SCOPE = {
        'form_add_url' : "<?php echo url('dataconfiguration/rendomSelectByMachine'); ?>",
    }
</script>
</html>