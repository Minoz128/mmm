<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"C:\xampp\htdocs\mmm\public/../application/index\view\auth\authrule.html";i:1548205508;s:61:"C:\xampp\htdocs\mmm\application\index\view\public\header.html";i:1548205508;s:61:"C:\xampp\htdocs\mmm\application\index\view\public\footer.html";i:1548205508;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <table class="my-table table table-border table-bordered table-bg table-hover table-sort table-responsive">
        ...
        <td colspan="4" style="text-align: left;text-indent: 260px;">
            <?php if(is_array($tree) || $tree instanceof \think\Collection || $tree instanceof \think\Paginator): $i = 0; $__LIST__ = $tree;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <div style="padding: 5px 10px;font-size: 14px"><input type="checkbox" id="<?php echo $vo['id']; ?>" name="ids" value="<?php echo $vo['id']; ?>"><strong><?php echo $vo['title']; ?></strong></div>
