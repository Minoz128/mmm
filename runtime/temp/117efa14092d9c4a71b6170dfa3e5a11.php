...
<div class="page-container">
    <div class="text-c">
        当前总数据 : <span><strong><a style="color:lightseagreen;text-decoration:underline" href="<?php echo url('Datainput/patch',['status'=>2]); ?>"><?php echo $allCount; ?></a></strong></span> 条
        已审核数据 : <span><strong><a style="color:green;text-decoration:underline" href="<?php echo url('Datainput/patch',['status'=>1]); ?>"><?php echo $status1Count; ?></a></strong></span> 条
        未审核数据 : <span><strong><a style="color:red;text-decoration:underline" href="<?php echo url('Datainput/patch',['status'=>0]); ?>"><?php echo $status0Count; ?></a></strong></span> 条
    </div>
