<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"C:\xampp\htdocs\mmm\public/../application/index\view\auth\addgroup.html";i:1548205508;s:61:"C:\xampp\htdocs\mmm\application\index\view\public\header.html";i:1548205508;s:61:"C:\xampp\htdocs\mmm\application\index\view\public\footer.html";i:1548205508;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="form form-horizontal" id="form-mmm-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="填写用户组名称" id="title" name="title">
            </div>
        </div>
...
<script>
    var SCOPE = {
        'form_add_url' : "<?php echo url('auth/addgroup'); ?>",
    }
</script>
</html>