<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"C:\xampp\htdocs\mmm\public/../application/index\view\tagbase\addparenttag.html";i:1547209534;s:61:"C:\xampp\htdocs\mmm\application\index\view\public\header.html";i:1547209534;s:61:"C:\xampp\htdocs\mmm\application\index\view\public\footer.html";i:1547398902;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<article class="page-container">
    <form class="form form-horizontal" id="form-mmm-add">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>实验：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <span class="select-box">
                    <select name="connectbaseid" class="select">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>标签组名称：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="填写标签组名称" id="tagname" name="tagname">
            </div>
        </div>
...
<script>
    var SCOPE = {
        'form_add_url' : "<?php echo url('tagbase/addparenttag'); ?>",
    }
</script>
</html>