<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"C:\xampp\htdocs\mmm\public/../application/index\view\auth\addfatherrule.html";i:1548213639;s:61:"C:\xampp\htdocs\mmm\application\index\view\public\header.html";i:1548205508;s:61:"C:\xampp\htdocs\mmm\application\index\view\public\footer.html";i:1548205508;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="form form-horizontal" id="form-mmm-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="填写父栏目名称" id="title" name="title">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="填写标识" id="name" name="name">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="详见 http://www.h-ui.net/Hui-3.7-Hui-iconfont.shtml" id="icon" name="icon">
            </div>
        </div>
...
<script>
    var SCOPE = {
        'form_add_url' : "<?php echo url('auth/addfatherrule'); ?>",
    }
</script>
</html>