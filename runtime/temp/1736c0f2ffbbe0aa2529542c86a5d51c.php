<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"C:\xampp\htdocs\mmm\public/../application/index\view\auth\editsonrule.html";i:1548214708;s:61:"C:\xampp\htdocs\mmm\application\index\view\public\header.html";i:1548205508;s:61:"C:\xampp\htdocs\mmm\application\index\view\public\footer.html";i:1548205508;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<article class="page-container">
    <form class="form form-horizontal" id="form-mmm-add">
                ...
                <span class="select-box">
                    <select name="nid" class="select">
                        ...
                        <?php if(is_array($fatherdata) || $fatherdata instanceof \think\Collection || $fatherdata instanceof \think\Paginator): $i = 0; $__LIST__ = $fatherdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <option value="<?php echo $vo['id']; ?>" <?php if($data['nid'] == $vo['id']): ?> selected="selected"<?php endif; ?>><?php echo $vo['title']; ?></option>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $data['title']; ?>" placeholder="填写栏目名称" id="title" name="title">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $data['name']; ?>" placeholder="填写URL 按照模块名/控制器名/方法名" id="name" name="name">
            </div>
        </div>
...
<script>
    var SCOPE = {
        'form_add_url' : "<?php echo url('auth/editsonrule'); ?>",
    }
</script>
</html>